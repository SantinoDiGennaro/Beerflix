    ...
    return(
        <footer class="h-fit py-6 bg-black/80 flex flex-col justify-center items-center lg:flex-row lg:justify-around">
            <div name="su di noi" class="flex flex-col items-center">
                ...
                <p class="text-sm text-[#ece7d3] text-center">©2023 Develhope FS8 - Group one</p>
                <p class="text-sm text-[#ece7d3] text-center">P.IVA 0123456789 - N. iscrizione al Registro imprese PA-123456</p>
                <p class="text-sm text-[#ece7d3] text-center">PEC beerflix@pec.com | SEDE Via Roma n. 174 - Palermo</p>
            </div>
