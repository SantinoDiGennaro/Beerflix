            ...
            <div className="pt-28 pl-8">
                <div className="flex flex-col">
                    ...
                    <Link
                        to="selection"
                        role="button"
                        className="animate-pulse w-[180px] h-[50px] text-[#180000] bg-[#ece7d3] ease-in-out duration-500 hover:animate-none hover:text-[#ece7d3] hover:font-bold hover:text-xl hover:bg-black hover:border-solid-[#ece7d3] no-underline text-center pt-2.5 mt-4 rounded-lg"
                    >
                        SCOPRI DI PIÙ
                    </Link>
                </div>
