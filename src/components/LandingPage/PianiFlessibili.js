...
export function PianiFlessibili() {
    return (
        <div className="bg-gradient-to-b from-[#ece7d3] to-[#180000]  w-full h-[560px] border-t-4 border-[#fb9f1f] bg-origin-border p-4  bg-cover bg-[center_bottom_0px] bg-no-repeat " style={{backgroundImage: `url(${wowImg})`}} >
            <div className="pt-6 flex justify-center ">
                <div className="flex flex-col items-center">
                    <h1 className="text-4xl text-black font-bold">Piani Flessibili</h1>
                    <h2 className="text-2xl text-black font-bold">per ogni tua esigenza</h2>
