            ...
            >
                <div name="card" className="w-[200px]">
                    ...
                    <h4 className="pb-2 pt-2 text-center">
                        Oltre 100 marchi, aggiornati ogni settimana,
                        accuratamente selezionate dai nostri mastri birrai
                    </h4>
                </div>
                <div name="card" className="w-[200px]">
                    ...
                    <h4 className="pb-2 pt-2 text-center">
                        Personalizza la tua box e metti in pausa, riattiva o
                        cancella il tuo abbonamento quando vuoi{" "}
                    </h4>
                </div>
                <div name="card" className="w-[200px]">
